...
# This is an example to execute the pipeline. it replaces the parameters values in the JSON with .env and send the JSON to the aws sagemaker CLI.
...
JSON_FILE="$SCRIPT_DIR/DWAPipeline-Scenario-1.json"
...
rm -f "$SCRIPT_DIR/DWAPipeline-Scenario-1-processed.json"
...
aws sagemaker start-pipeline-execution \
    ...
    --pipeline-parameters file://$SCRIPT_DIR/DWAPipeline-Scenario-1-processed.json \
